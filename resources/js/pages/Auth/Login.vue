...
<template>
    <main class="w-full min-h-svh max-h-svh flex items-center justify-center">
        <Card class="w-full max-w-sm ">
            ...
            <CardFooter>
                <p class="text-sm">
                    Don't have an account? <Link :href="route('register')" class="text-rose-500 hover:underline">Register</Link>
                </p>
            </CardFooter>
        </Card>
    </main>
